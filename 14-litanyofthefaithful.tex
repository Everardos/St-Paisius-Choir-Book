...
\begin{liturgicaltext}
    ...
    \choirsemisecret \lilypondfile[insert=inline, inline-staffsize=20, valign=top]{lilypond/files/99 litanies/obikhod/litany-obikhod-part1.ly}\marginnote{\rubric{\small Slowly, if there be no deacon}}[1.5cm]
\end{liturgicaltext}
\begin{semisecret}
