\section{first litany of the faithful}
...
\begin{liturgicaltext}
    ...
    \choirsemisecret \lilypondfile[insert=inline, inline-staffsize=20, valign=top]{lilypond/files/99 litanies/kedrov-faithful/kedrov-lhm-1.ly} \marginnote{\rubric{\small Slowly, if there be no deacon}}[1.5cm]
\end{liturgicaltext}
\begin{semisecret}
...
\end{semisecret} \pagebreak
\begin{liturgicaltext}
    \deacon Help us, save us, have mercy on us, and keep us, O God, by Thy grace.
    \choir \lilypondfile[insert=inline, inline-staffsize=20, valign=top]{lilypond/files/99 litanies/kedrov-faithful/kedrov-lhm-2.ly} 
    \deacon Wisdom!
    ...
    \choir \lilypondfile[insert=inline, inline-staffsize=20, valign=top]{lilypond/files/99 litanies/kedrov-faithful/kedrov-amen-1.ly} 
\end{liturgicaltext} \newpage

\section{second litany of the faithful}
\begin{liturgicaltext}
...
\begin{rubricsection}
    ...
    \begin{liturgicaltext}
        ...
        \choir \lilypondfile[insert=inline, inline-staffsize=20, valign=top]{lilypond/files/99 litanies/kedrov-faithful/kedrov-lhm-1.ly} 
...
\begin{liturgicaltext}
    ...
    \choir \lilypondfile[insert=inline, inline-staffsize=20, valign=top]{lilypond/files/99 litanies/kedrov-faithful/kedrov-amen-2.ly} 
\end{liturgicaltext}