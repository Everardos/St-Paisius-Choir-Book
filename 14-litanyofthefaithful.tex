...
\begin{liturgicaltext}
    ...
    \choirsemisecret \lilypondfile[insert=inline, inline-staffsize=20, valign=top]{lilypond/files/99 litanies/obikhod/litany-obikhod-part1.ly}
    \item[] \rubric{(Slowly, if there be no deacon.)}
\end{liturgicaltext}
\begin{semisecret}
