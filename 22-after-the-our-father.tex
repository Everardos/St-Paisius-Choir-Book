...
\begin{liturgicaltext}
    ...
    \choir \lilypondfile[insert=inline, inline-staffsize=20, valign=top]{lilypond/files/99 litanies/obikhod/litany-obikhod-tothee.ly} \marginnote{\rubric{\small Slowly, always}}[1.5cm] \pagebreak
\end{liturgicaltext}
\begin{semisecret}
...
\begin{liturgicaltext}
    ...
    \priest Holy Things are for the holy. \pagebreak
    \choir
\end{liturgicaltext}
